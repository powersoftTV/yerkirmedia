...
<link rel="stylesheet" type="text/css" href="<?=$_PATH?>css/jquery.mobile-1.2.1.min.css" />
...
<script type="text/javascript" src="<?=$_PATH?>js/jquery.mobile-1.2.1.min.js"></script>
...
<div data-role="page" id="homePage" data-theme="d">
    ...
    if($page=="") { ?>
        <span  style="float:right; padding-right:7px;">
            ...
            <span class='lang' style='float:left;  padding:0 8px 0 8px;'>
    			<a rel='external' href="?lan=ru" <? if($lan=="ru") echo" class='activeAFooter'"; ?>>Рус</a>
            </span>
            <span class='lang' style='float:left;  padding:0 8px 0 8px;'>
			    <a rel='external' href="?lan=en" <? if($lan=="en") echo" class='activeAFooter'"; ?>>Eng</a>
            </span>
        </span>
	   ...
	   for($i=0;$i<10;$i++) {
		  ...
		  echo'<div class="topNewsDiv">
                ...
                <div class="topNewsContent">
                    ...
                    <p class="TopN_p"><span class="p_time">'.$r_date.'</span> '.($r_video>0?'<a href="?lan='.$lan.'&amp;page=news&amp;id='.$r_id.'#video" class="video"></a>':"").'</p>
                </div>
               </div>';
		  if($i==2)echo'<div class="moreTopNews">';
	   }
	   echo"</div>";
 ...
 elseif($page=="news" && !$id) {?>
    <span  style="float:right; padding-right:7px;">
        ...
        <span class='lang' style='float:left;  padding:0 8px 0 8px;'>
		   <a rel='external' href="?page=<?=$page?>&amp;lan=ru" <? if($lan=="ru") echo" class='activeAFooter'"; ?>>Рус</a>
        </span>
        <span class='lang' style='float:left;  padding:0 8px 0 8px;'> 
		    <a rel='external' href="?page=<?=$page?>&amp;lan=en" <? if($lan=="en") echo" class='activeAFooter'"; ?>>Eng</a>
        </span>
    </span>
    <?
 ...
 elseif($page=="news" && $id) {
    ...
    <span  style="float:right; padding-right:7px;">
        ...
        if($title_ru !=""){?>
        <span class='lang' style='float:left;  padding:0 8px 0 8px; background:none' >
		    <a rel='external' href="?page=<?=$page?>&amp;lan=ru&amp;id=<?=$id?>" <? if($lan=="ru") echo "class='activeAFooter'";?>>Рус</a>
        </span>
        <? }
        if($title_en !=""){?>
        <span class='lang' style='float:left;  padding:0 8px 0 8px; background:none' >
		    <a rel='external' href="?page=<?=$page?>&amp;lan=en&amp;id=<?=$id?>" <? if($lan=="en") echo "class='activeAFooter'";?>>Eng</a>
        </span>
        <? }?>
    </span>
    <? if ($r_title_r){
 ...
 elseif($page=="stream") { ?>
    ...
    <div data-role="footer" id="footerDiv" data-position="fixed">
		<div data-role="navbar">
			<ul>
                <li><a rel='external' href="/android/?lan=<?=$lan?>"><?=$main?></a></li>
				<li><a rel='external' href="/android/?page=news&amp;lan=<?=$lan?>"><?=$_LANG[10][$lan]?></a></li>
			</ul>
		</div><!-- /navbar -->
	</div>
    </div>

...
<div data-role="page" id="homePage" data-theme="d">
	...
	<div id="headerDiv">
		<a rel='external' href="/android/?lan=<?=$lan?>" id="logo">
        <img src='../s/i/logo<?=$lan?>.png' title='<?=$yerkir_media?>' 
        alt='<?=$yerkir_media?>' style='border:0px;' /></a>
	...
	<?PHP
			...
			echo'<div id="topNewsDiv">';
				...
				for($i=0;$i<10;$i++) {
					...
					echo'<div class="topNewsDiv">
							...
							<p class="TopN_p"><span class="p_time">'.$r_date.'</span> '.($r_video>0?'<a rel="external" href="?lan='.$lan.'&amp;page=news&amp;id='.$r_id.'#video" class="video"></a>':"").'</p></div>
		...
		elseif($page=="stream") {
			...
			echo'<center><iframe width="400" height="400" src="http://cdn.livestream.com/embed/yerkirmedia?layout=4&amp;autoplay=false" style="border:0;outline:0" frameborder="0" scrolling="no"></iframe></center>';
		}

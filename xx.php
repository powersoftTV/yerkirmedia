...
if ( ! empty( $id ) && empty( $act ) ) $act = "news" ;
...
if ( $act == "news" && $id )
{
    $resh = mysql_query( "SELECT * FROM `records` WHERE `r_category` > 0 AND `r_show_$lan` = 1 AND `id` = '" .$id . "' Order by `id` desc " ) ;
        ...
        foreach ( $rowarray as $e )
        {
            foreach ( $temp as $f )
            {
                if ( mb_strrichr( $e, $f, true, 'utf-8' ) !== false )
                {
                    ...
                    $sovpadenie = mb_substr( $e, mb_strlen( $skizb, 'utf-8' ), mb_strlen( $f,'utf-8' ), 'utf-8' ) ;
                    $ostatok = mb_substr( $e, mb_strlen( $skizb, 'utf-8' ) + mb_strlen( $f, 'utf-8' ),mb_strlen( $e, 'utf-8' ) - mb_strlen( $skizb, 'utf-8' ) - mb_strlen( $f, 'utf-8' ),'utf-8' ) ;
                    $sovpadenie = "<span style='font-weight:800; font-size:16px'>" . $sovpadenie ."</span>" ;
                    $rowarray[$i] = $skizb . $sovpadenie . $ostatok ;
                }
            }
            $i++ ;
    ...
    if($lan == "en")$ym_title = $r_title_r . " | News" ;
    elseif($lan == "ru")$ym_title = $r_title_r . " | Новости" ;
    else $ym_title = $r_title_r . " | Նորություններ" ;
}
if ( $act == "prog" && $id )
{
...
if ( isset( $_SESSION['ym_poll'] ) && intval( $_SESSION['ym_poll'] ) ) setcookie( "ym_poll", $q_id, time() + 28000 ) ;
$r_keywords_r .= $yerkir_media ;
///select end
if ( isset( $ym_title ) ) $ym_title .= " |" ;
...
<meta name="description" content="<?=str_replace( '"', "&quot;", $r_title_r ) ;?>" />
<meta name="keywords" content="<?=$r_keywords_r?>" />
...
<title><?=$ym_title?> <?=$yerkir_media?></title>
<?
$r_pic_r=str_replace(" ","%20",$r_pic_r);
 if($act=="news" && $id){?>
		<meta property="og:title" content="<?=str_replace('"',"&quot;",$ym_title)?> <?=$yerkir_media?>" /> 
		<meta property="og:type" content="article">
		<meta property="og:url" content="http://www.yerkirmedia.am/indexx.php?act=news&lan=<?=$lan?>&id=<?=$id?>" />
		<meta property="og:site_name" content="Yerkir Media">
		<meta property="og:image" content="http://www.yerkirmedia.am/userfiles/<?=$r_pic_r?>" />
		<meta property="og:description" content="<?=$r_short_r?>" />  
        
	<? }
	elseif($act=="pages" && $id){?> 
		<meta property="og:title" content="<?=str_replace('"',"&quot;",$ym_title)?> <?=$yerkir_media?>" /> 
		<meta property="og:type" content="article" />
		<meta property="og:url" content="http://www.yerkirmedia.am/indexx.php?act=pages&lan=<?=$lan?>&id=<?=$id?>" />
		<meta property="og:site_name" content="Yerkir Media">
		<meta property="og:image" content="http://www.yerkirmedia.am/ym.jpg" />
		<meta property="og:description" content="<?=str_replace('"',"&quot;",$ym_title)?> <?=$yerkir_media?>" />
	<? }
	elseif($act=="prog" && $id){?>
		<meta property="og:title" content="<?=str_replace('"',"&quot;",$ym_title)?> <?=$yerkir_media?>" /> 
		<meta property="og:type" content="article">
		<meta property="og:url" content="http://www.yerkirmedia.am/indexx.php?act=prog&lan=<?=$lan?>&id=<?=$id?>" />
		<meta property="og:site_name" content="Yerkir Media">
        <? if($f_desc){?>
         			 <meta property="og:description" content="<?=str_replace('"',"&quot;",$ym_title1)?> <?=$yerkir_media?>" />
              	<? } 
				else {?>
            		<meta property="og:description" content="<?=$ym_title?>" />
           		<? }
	...
	elseif($act=="yerkir"){?>
		<meta property="og:title" content="<?=str_replace('"',"&quot;",$ym_title)?> <?=$yerkir_media?>" /> 
		<meta property="og:type" content="article">
		<meta property="og:url" content="http://www.yerkirmedia.am/indexx.php?act=yerkir&lan=<?=$lan?>">
		<meta property="og:site_name" content="Yerkir Media">
        <meta property="og:description" content="<?=str_replace('"',"&quot;",$ym_title1)?> <?=$yerkir_media?>" />
        <? if(isset($r_pic_r) && $r_pic_r){ ?>
        	<meta property="og:image" content="http://www.yerkirmedia.am/userfiles/<?=$r_pic_r?>" />
	...
	elseif($act=="ether"){?>
		<meta property="og:title" content="Ծրագիր" /> 
		<meta property="og:type" content="article">
		<meta property="og:url" content="http://www.yerkirmedia.am/indexx.php?act=ether">
		<meta property="og:site_name" content="Yerkir Media">
        <meta property="og:description" content="Ծրագիր" />
       	<meta property="og:image" content="http://www.yerkirmedia.am/ym.jpg" />
        <?
		}
	elseif($act=="films"){
			if($id){	?>
                ...
                <meta property="og:type" content="article">
				<meta property="og:site_name" content="Yerkir Media">
        		<meta property="og:url" content="http://www.yerkirmedia.am/indexx.php?act=films&id=<?=$id?>">
       			<meta property="og:image" content="http://www.yerkirmedia.am/userfiles/<?=$r_pic_r?>" />
        	 <? if($f_desc){?>
         			<meta property="og:description" content="<?=$f_desc?>" />
              	<? } 
				else {?>
            		<meta property="og:description" content="<?=$f_name?>" />
           		<? } 
			}
			else {?>
        		<meta property="og:title" content="Ֆիլմեր" />
            	<meta property="og:type" content="article">
				<meta property="og:site_name" content="Yerkir Media">
        		<meta property="og:url" content="http://www.yerkirmedia.am/indexx.php?act=films">
       			<meta property="og:image" content="http://www.yerkirmedia.am/ym.jpg" />
            	<meta property="og:description" content="Ֆիլմեր" />
          <? }
		} 
	else{ ?>
		<meta property="og:title" content="Yerkirmedia TV" /> 
		<meta property="og:type" content="article">
		<meta property="og:url" content="http://www.yerkirmedia.am/indexx.php?lan=<?=$lan?>"/>
		<meta property="og:site_name" content="Yerkir Media">
		<meta property="og:image" content="http://www.yerkirmedia.am/ym.jpg" />
		<meta property="og:description" content="<?=$yerkir_media?>" />
        <link rel="canonical" href="http://www.yerkirmedia.am/indexx.php" />
	<? }?>
...
<div id="header" style="margin-top:5px">
    <a href="/<? if($lan=="en") echo"?lan=en";?>" id="logo"><img src='s/i/logo<?=$lan?>.png' title='<?=$yerkir_media?>' alt='<?=$yerkir_media?>' style='border:0px;' /></a>
    <pre align="right">
    <div id="top_b">
    <?
		...
		if($count_banners) {
			...
			if($b_link) echo"<a href='$b_link'>";
			if($b_pic) echo"<img src='userfiles/$b_pic' alt='' />";
			if($b_link) echo"</a>";
		}
	?> 
    </div>
...
<div id="menu">
	<ul>
		<li><a href="/mobile/?lan=<?=$lan?>" id="menu_WAP">Mobile</a></li>
		<?
		...
		if(isset($id) && $id==3 && $act=="pages") echo "style='background-color:#ff7c02;color:#000;text-decoration:none;'";
		echo">".$_LANG[2][$lan]."</a></li>";
		if($lan=="hy") {?>
			<li><a href='?act=ether' class='menu' <?if($act=="ether") echo "style='background-color:#ff7c02;color:#000;text-decoration:none;'";?>>Ծրագիր</a></li>
			<li><a href='?act=films' class='menu' <?if($act=="films") echo "style='background-color:#ff7c02;color:#000;text-decoration:none;'";?>>Ֆիլմեր</a></li>
		<? }
		echo"<li><a href='?act=pages&amp;lan=$lan&amp;id=4' class='menu'";
		if(isset($id) && $id==4 && $act=="pages") echo "style='background-color:#ff7c02;color:#000;text-decoration:none;'";
		echo">".$_LANG[6][$lan]."</a></li>";
		echo"<li><a href='?act=pages&amp;lan=$lan&amp;id=2' class='menu'";
		if(isset($id) && $id==2 && $act=="pages") echo "style='background-color:#ff7c02;color:#000;text-decoration:none;'";
		echo">".$_LANG[7][$lan]."</a></li>";
		echo"<li><a href='?act=pages&amp;lan=$lan&amp;id=5' class='menu'";
		if(isset($id) && $id==5 && $act=="pages") echo "style='background-color:#ff7c02;color:#000;text-decoration:none;'";
		echo">".$_LANG[8][$lan]."</a></li>";
		 ...
		 for($i=0;$i<$count;$i++)	{
				...
				echo"<li><a href='?act=pages&amp;lan=$lan&amp;id=$id_r' class='menu' ";
				 ...
				 if(isset($id) && $id==$id_r && $act=="pages") echo "style='background-color:#ff7c02;color:#000;text-decoration:none;'";
		...
		?>
		<!-- AM-->
		<li id="menu_archive" style="width:65px"><a class='menu' href="#" >Արխիվ</a>
			<ul id="menu_archive_list" class="newmenu">
				<li id="li1" class="newmenu"><a class='newcolor menu' href="?act=archive_programs" >հաղորդումներ</a></li>
				<li id="li2" class="newmenu"><a class='newcolor menu' href="?act=archive_news"  >լուրեր</a></li>
			</ul>
		</li>
		<li>
    		<form action>
				...
				<span style="width:140px; padding:0 5px; background:none" class="search">
					<input  type="text" id="search" name='w' value="<?=$_LANG[9][$lan]?>" onfocus="hideInp(this,'<?=$_LANG[9][$lan]?>')" />
	   ...
	   <li  style="float:right; padding-right:7px;">
		<span class='lang' style='float:left; padding:0 4px 0 4px; background:none' ><a href="?lan=hy" <? if($lan=="hy") echo" class='active'"; ?>>Հայ</a></span>
		<span class='lang' style='float:left; padding:0 4px 0 4px;'><a href="?lan=ru" <? if($lan=="ru") echo" class='active'"; ?>>Рус</a></span>
		<span class='lang' style='float:left; padding:0 4px 0 4px;'> <a href="?lan=en" <? if($lan=="en") echo" class='active'"; ?>>Eng</a></span></li>
    </ul>
</div>
<!--MENU END-->
...
<div id="body">
	...
	<div id="left">
		...
		<!-- ankexc asac -->
		<div class="header">
			<h2><a class="ankexcAsacA" href="?act=cat&lan=<?=$lan?>&id=21">Անկեղծ ասած...</a></h2>
		</div>
		<div>
				<?
						$resh_ank = mysql_query("SELECT * FROM `records` WHERE `r_category` = 21 AND `r_show_".$lan."` > 0 Order by `r_ord` desc LIMIT 2");
	...
	if($lan=="hy"){
		...
		if($_SESSION['ym_poll']==$id_q || $_COOKIE['ym_poll']==$id_q ){
			if(!$_COOKIE['ym_poll']) $_COOKIE['ym_poll'] = $id_q;
			$GLOBALS="<div class='q'>$poll_q</div><div class='a'><ul>"; 
			$resh = mysql_query("SELECT * FROM `ym_poll_a` WHERE `q_id` = '".$id_q."' AND `poll_a` != ''  ORDER by `id` ");
			...
			for($i=0;$i<$count;$i++){
				...
				$tok=sprintf("%.2f",$tok);
				$GLOBALS.="<li><label>".$poll_a." <span style='font-size:9px;'>(".$tok."%, ".$poll_a_v." անգամ)</span></label><br /><p style='width:".$width."px;height:8px;background:url(s/i/background_orange.png)'></p></li>";
			}
			$GLOBALS.="</ul><br /><a href='?act=polls'>Դիտել նախորդ հարցումները</a><br /><br /></div>";
			echo $GLOBALS;
		}
			...
			<div class="a"><form name='pollform'>
    	        ...
    	        $id_a = mysql_result($resh, $i, "id");
    	        $poll_a = mysql_result($resh, $i, "poll_a");
				echo"<li><label><input type='radio' name='poll_a' value='".$id_a."' /> ".$poll_a."</label></li>";
				}
				?>
		...
		<?
			...
			<div id='yh_top'>&nbsp;&nbsp;<?=$v_eter?></div>
			<a href='?act=yerkir'><img src="s/i/yerkri_harc.png" alt="Երկրի հարցը" style='border:0px;' /></a>
			<div id='yh_marquee'><marquee scrollamount='3'><?=$v_desc?></marquee></div>
            <?=$v_name?>
		</div>
		<!--YERKRI HARC END-->
		<? } ?>
		...
		<div class="header">
			<h2><? if($lan=="hy")echo"Տեղեկատվական այլ կայքեր";elseif($lan=="ru") echo"Другие информационные сайты"; else echo"Other news sites";?></h2>
		</div>
		...
		<div id="gorcynkerner_1">
			...
			for($i=0;$i<$count_banners;$i++){
				...
				if($b_pic_1) echo"<a href='$b_link_1' target='_blank'><img src='userfiles/$b_pic_1' alt='' style='border:0px;width:276px;'/></a>";		
			}
	...
	<!--	<div class='gorcynkerner_1'>
		...
		<? 
		  ...
		  for($j=0;$j<6;$j++) {
			  ...
			  for($i=0;$i<$count;$i++)	{
				...
				if($id_h=="5") $href="?act=yerkir"; else $href="?lan=$lan&act=prog&id=$id_h";

				if($h_bajin==$j) echo"<a href='".$href."'><img src='userfiles/".$h_nkar."' title='".$h_name."' alt='".$h_name."' style='width:300px;border:0px;' usemap='' alt=''/></a><p style='margin-bottom:5px;padding-left:3px;padding-right:3px;'>'".$h_name."' - ".$h_text."<a href='".$href."' class='video'></a></p>";
			  }				  
			  echo"</div>";
		  }
		?>
		...
		<?php /*?><div style="clear:both;margin-top:5px;">
	...
	<div id="right">
		...
		?>
			...
			<div id="TopN_IM">
				<img src="userfiles/<?=$r_pic_r_1?>" style="width:300px;" id="img_1" class="img_123"/>
				<img src="userfiles/<?=$r_pic_r_2?>" style="width:300px;display:none;" id="img_2" class="img_123"/>
				<img src="userfiles/<?=$r_pic_r_3?>" style="width:300px;display:none;" id="img_3" class="img_123"/>
			</div>

			<div id="TopN_IM_content" style="height:240px;">

				<div class="short_TopN">
					<h2 class="h2_123" id="h2_1" style="opacity:0.55;"><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r_1?>" style="font-size:14px;"><?=$r_title_r_1?></a></h2>
					<p class="TopN_p"><span class='p_time'><?=$r_date_r_1?></span> <?if($r_video_r_1){?><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r_1?>#video" class="video"></a><?}?></p>
				</div>

				<div class="short_TopN">
					<h2 class="h2_123" id="h2_2"><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r_2?>" style="font-size:14px;"><?=$r_title_r_2?></a></h2>
					<p class="TopN_p"><span class='p_time'><?=$r_date_r_2?></span> <?if($r_video_r_2){?><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r_2?>#video" class="video"></a><?}?></p>
				</div>
				<div class="short_TopN" style="height:76px;">
					<h2 class="h2_123" id="h2_3"><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r_3?>" style="font-size:14px;"><?=$r_title_r_3?></a></h2>
					<p class="TopN_p"><span class='p_time'><?=$r_date_r_3?></span> <?if($r_video_r_3){?><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r_3?>#video" class="video"></a><?}?></p>
				</div>
		...
		<!-- VIDEO BLOG -->
		<div class="header noborder" style="background:#e4e4e4;border:1px solid #bfbfbf;height:18px;margin-top:20px;"><h2 <?if($lan=="hy") echo'onclick="document.location='."'".'http://www.youtube.com/user/yerkirmediatv?feature=results_main'."'".'" style="cursor:pointer;" '; ?> ><?if($lan=="hy")echo"Տեսանյութեր";elseif($lan=="ru") echo"Видео"; else echo"Video";?> <img src="s/i/video_f.png" style="margin-left:10px;" alt=''/></h2></div>
		
		<div id="top" style="margin-top:0px;">
			<div class='video_screenshots' style="margin-top:20px;">
				<ul>
				<?
					$resh = mysql_query("SELECT `id`, `r_pic`, `r_title_".$lan."` FROM `records` WHERE `r_category` > 0 AND `r_video_".$lan."`!='' AND `r_show_$lan` = 1 AND `id` NOT IN (".$r_id_r_1.",". $r_id_r_2.",".$r_id_r_3.") Order by `r_ord` desc LIMIT 18 ");
					$count = @mysql_num_rows($resh);
		...
		elseif($act=="archive_programs"){
		 ...
		 if($id==4){ $st = "style='background: url(s/i/Plazma.png) no-repeat top left;'";}

		if($r_text_r) echo"<div id='supertop' ".$st.">".$r_text_r."<br /><br />";
		 else echo"<div id=\"supertop\">";
			...
			$count_h = @mysql_num_rows($resh_h);
				...
				?>
					...
					<div class="haxordumner_top"><p><?=$c_name_b?></p></div>
					<div class="image_h">
					<?if($h_nkar_b){
					...
					?>
						<a href='?<?=$actNN?>'><img src="userfiles/<?=$h_nkar_b?>" alt="" style='border:0px;' usemap='' title="Դիտել '<?=$c_name_b?>' հաղորդաշարի տեսգրությունները"/></a>
					...
					<!-- AM -->
					<div class="content_h">
						<p><?=$c_desc_b?>  <a href='?<?=$actNN?>' class='video'> դիտել </a></p>
					</div>
		...
		<form method = 'get' id="archive_news_search" action='?'>
			...
			if($getDateNews)
				$querySearchNews = "SELECT * FROM `records` WHERE `r_show_$lan` = '1' AND `r_fullDate` LIKE '%".$getDateNews."%' Order by `r_ord` desc";
			if($querySearchNews)
		...
		if($getDateNews != ''){
			...
			<div id="search_top" ><p>Արդյունքները</p></div>
			  ...
			  if(!$count) echo "Փնտրման արդյունքը դատարկ է: <br/><br/>";
				...
				for($i=0;$i<$count;$i++){
				 ...
				 $r_date_r = mysql_result($resh, $i, "r_date");
					...
					<div class="image_c">
						<?if($r_pic_r){?><img src="userfiles/<?=$r_pic_r?>" alt="" /><?}?>
					</div>
					<div class="content_c">
						<h2><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>"><?=$r_title_r?></a> 
						<?if($r_video_r){?><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>" class="video"><?=$_LANG[4][$lan]?></a><?}?>
						</h2>
						<p><span class='p_time'><?=$r_date_r?></span><br /><?=$r_short_r?> <a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>"><?=$_LANG[5][$lan]?></a></p>
					</div>
					<div style="clear:both;"></div>
					<br /><br /><br />
	...
	?>
		...
		<!--NEWS FEED START-->
		<div class="header noborder"><h2><?=$_LANG[10][$lan]?></h2></div>
		<div id="news_feed">
			<ul>
			...
			?>
				<li><span class="time"><?=$r_date_r[0]?></span><span class="sep"> . </span><span class="date"><?=$r_date_r[1]?></span> <a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>" class="title"><?=$r_title_r?></a> <?if($r_video_r){?><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>#video" class="video"><?=$_LANG[4][$lan]?></a><?}?></li>
		 ...
		 if($id==3){
			...
			$count_h = @mysql_num_rows($resh_h);
				...
				?>
					...
					<div class="content_h">
						<p><?=$c_desc_b?> <a href='?<?=$actNN?>' class='video'></a></p>
					</div>
		...
		elseif($act=="prog"){
			...
			$resh_h = mysql_query("SELECT * FROM `haxordumner_videos` WHERE `h_id`='".$id."' Order by `id` desc ");
			$count_h = @mysql_num_rows($resh_h);
			  ?><div class="haxordumner_top"><p><?=$h_name?></p></div><?
				...
				?>
					...
					<?=$v_url_b?>
					<p style='text-align:left;'><b><?=$v_name_b?></b></p>
					</div>
				<?
					if($iMN%2==0 && $i>0) echo"<div style='clear:both;'></div><br /><br /><br />";
				}
				if($iMN%2==1) echo"<div style='clear:both;'></div><br /><br /><br />";
		...
		elseif($act=="search"){
			...
			if($_GET['w'] && $_GET['w']!=$_LANG[19][$lan] && $_GET['w']!=""){
				...
				if($search!=""){
					if($getDate && $getDate!=""){
					$query = "SELECT * FROM `records` WHERE  `r_show_$lan` AND (`r_title_$lan`  LIKE '%". str_replace(" ", "%' AND `r_title_$lan` LIKE '%", $search). "%' OR `r_text_$lan` LIKE '%". str_replace(" ", "%' AND `r_text_$lan` LIKE '%", $search). "%') AND `r_fullDate` LIKE '%".$getDate."%' ORDER BY `r_ord` DESC ";
					}
					else $query = "SELECT * FROM `records` WHERE  `r_show_$lan` AND (`r_title_$lan`  LIKE '%". str_replace(" ", "%' AND `r_title_$lan` LIKE '%", $search). "%' OR `r_text_$lan` LIKE '%". str_replace(" ", "%' AND `r_text_$lan` LIKE '%", $search). "%') ORDER BY `r_ord` DESC ";
				}
			}
			else {
				if($getDate && $getDate!="") $query = "SELECT * FROM `records` WHERE  `r_show_$lan`  AND `r_fullDate` LIKE '%".$getDate."%' ORDER BY `r_ord` DESC ";
			}
			if($query){
	  ...
	  ?>
				<div style="overflow:hidden;margin:8px 0;">
					<h3 style="margin:0 0 5px 0;"><?=$_LANG[14][$lan]?></h3>
					<form action="?" method="Get">
						<input type="hidden" value="search" name="act" />
                        <input type="hidden" name="lan" value="<?=$lan?>" />
						<span style="float:left;margin-right:30px;">
							<?=$_LANG[15][$lan]?> <input type="text"  name="w" value="<?=$search?>" style="width:200px;"/>
						</span>
						<span style="float:left;margin-right:5px;">
							<?=$_LANG[22][$lan]?> <select name="day">
												<option value="0"> <?=$_LANG[16][$lan]?> </option>
												<?
													for($i=1;$i<=31;$i++) {
														$ij = (strlen($i)==1?"0".$i:$i);
										   ...
										   <select name="month">
												<option value="0"> <?=$_LANG[17][$lan]?> </option>
												<?
													for($i=1;$i<=12;$i++) {
														$ij = (strlen($i)==1?"0".$i:$i);
										   ...
										   <select name="year">
                                           		<option value="0"> <?=$_LANG[18][$lan]?> </option>
						...
						<span style="float:left;margin-right:15px;">
							<input type="submit" value=<?=$_LANG[19][$lan]?> />
						</span>						
					<form>
				</div>

				<div id="search_top" style='margin-bottom:8px;'><p><?=$_LANG[20][$lan]?></p></div>
			  <?
              if(!$total) echo $_LANG[21][$lan];
			  else {
				  ...
				  while($row=mysql_fetch_array($result)){
					...
					<div class="content_c">
                    	<? if($search && $search!=""){ ?>
						<h2><a href="?act=news&amp;lan=<?=$lan?>&amp;se=<?=$search ?>&amp;id=<?=$r_id_r?>"><?=$r_title_r?></a>
                        <? }
						else { ?>
                        <h2><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>"><?=$r_title_r?></a>
                        <? } 
                        ...
                        <? if($search && $search!=""){ ?>
						<p><span class='p_time'><?=substr( $r_date_r, 0, 6)." ".$r_fulldate;?></span><br /><?=$r_short_r?> <a href="?act=news&amp;lan=<?=$lan?>&amp;se=<?=$search ?>&amp;id=<?=$r_id_r?>"><?=$_LANG[5][$lan]?></a></p>
                        <? }
						else { ?>
                        <p><span class='p_time'><?=substr( $r_date_r, 0, 6)." ".$r_fulldate;?></span><br /><?=$r_short_r?> <a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>"><?=$_LANG[5][$lan]?></a></p>
                        <? } ?>
					</div>
					<div style="clear:both;"></div>
					<br /><br /><br />
			...
			if($search && $search!="") $dest=$dest."&w=$search";
		...
		elseif($act=="news_search"){
			...
			if($getDate && $w)
				$querySearch = "SELECT * FROM `records` WHERE `r_show_$lan` = '1' AND (`r_title_$lan` like '%".$w."%' OR `r_text_$lan` like '%".$w."%') AND `r_fullDate` LIKE '%".$getDate."%' Order by `r_ord` desc";
			elseif($w)
				$querySearch = "SELECT * FROM `records` WHERE `r_show_$lan` = '1' AND (`r_title_$lan` like '%".$w."%' OR `r_text_$lan` like '%".$w."%') Order by `r_ord` desc";
			elseif($getDate)
				$querySearch = "SELECT * FROM `records` WHERE `r_show_$lan` = '1' AND `r_fullDate` LIKE '%".$getDate."%' Order by `r_ord` desc";
			...
			$count = @mysql_num_rows($resh);
			  ?>
				<div style="overflow:hidden;margin:8px 0;">
					...
					<form action="?" method="Get">
						<input type="hidden" value="search" name="act" />
						<span style="float:left;margin-right:30px;">
							Բանալի բառ <input type="text"  name="w" value="<?=$_GET['w']?>" style="width:200px;"/>
						</span>
						<span style="float:left;margin-right:5px;">
							Ըստ ամսաթվի <select name="day">
										   ...
										   <select name="year">
												...
												<option value="11" <?=($_GET['year']=='11'?" SELECTED ":"")?>> 2011 </option>
												<option value="12" <?=($_GET['year']=='12'?" SELECTED ":"")?>> 2012 </option>
												<option value="13" <?=($_GET['year']=='13'?" SELECTED ":"")?>> 2013 </option>
										   </select>
						</span>
			  ...
			  if(!$count) echo"Փնտրման արդյունքը դատարկ է:";
			  exit();
			  if(!$w="") $w="";
			  if(!$day="") $day="";
			  if(!$month="") $month="";
		...
		?>
					<div class="haxordumner_top"><p><?=$c_name_b?></p></div>
					<div class="image_h">
					<?if($h_nkar_b){?><a href="?act=films&id=<?=$h_id?>"><img src="userfiles/<?=$h_nkar_b?>" alt="" style='border:0px;'/></a><?}?>
					</div>
					
					<div class="content_h">
						<p><?=$c_desc_b?> <a href="?act=films&id=<?=$h_id?>" class="video"><?=$_LANG[4][$lan]?></a></p>
					</div>
		 ...
		 echo"</div>";
			...
			elseif($id){
				echo"<div id=\"supertop\">";
				?><div class="haxordumner_top"><p><?=$f_name?></p></div><?
					$resh_h = mysql_query("SELECT * FROM `f_videos` WHERE `b_id` = '".$id."' Order by `id` desc ");
				...
				?>
					...
					<div class="content_h">
						...
						<p><br /><?=$v_eter_b?></p>
						<p><br /><?=$f_desc?></p>
                        <img src="userfiles/<?=$f_nkar?>" alt="" style="display:none;" />
					</div>
		...
		elseif($act=="ether"){
			...
			$count = @mysql_num_rows($resh);
		 	while ($resultEter = mysql_fetch_array($resh)) {
					echo"<p style='margin:10px 0px;width:40%;float:left;'><img src='/s/i/WordIcons.png' alt='' style='border:0px;width:20px;float: left;margin:0 5px 0 0'/> <a href='/userfiles/".$resultEter['e_name_simple']."' style='height:20px;line-height:20px;'> ".$resultEter['e_name_simple']."</a></p>";
			 }
		 	echo"</div>";
		}//ether
    ...
    echo "</div>" ; //supertop
		...
		elseif($act=="news" && $id){
		 ...
		 <div id="supertop">
			...
			<?if($r_pic_r){?><img src="userfiles/<?=$r_pic_r?>" alt="" style='float:left;max-width:400px;margin-right: 20px; margin-bottom: 20px;' /><?}?>

				<h2><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>"><?=$r_title_r?></a> 
				<?if($r_video_r){?><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>#video" class="video"><?=$_LANG[4][$lan]?></a><?}?>
				</h2>
				...
				<!-- comments start -->
				<?
					$resh_com = mysql_query("SELECT * FROM ` records_comments` WHERE `record_id` = '".$id."' AND `c_approve` = 1 ORDER BY id ");
					...
					if($count_com){
						...
						for($ic=0;$ic<$count_com;$ic++){
							...
							<p><span class='c_name'>".$c_name_b."</span> <span class='c_separate'> | </span> <span class='c_date'>".$c_date_b."</span></p>
							<p>".$c_com_b."</p></div>";
						}
					}
				?>
					<div id='author_comment'><br /><input type='hidden' id='com_post_id' value='<?=$id?>'>
		...
		<?
			$ii = rand(0, 1);
			if($ii==0){
				for($i=0;$i<$count_banners;$i++){continue;
					$b_type_b = mysql_result($resh_banners, $i, "b_type");
					if($b_type_b == 2) {
						$b_pic_1 = mysql_result($resh_banners, $i, "b_pic");
						$b_link_1 = mysql_result($resh_banners, $i, "b_link");
						if($b_pic_1) echo"<a href='$b_link_1' target='_blank'><img src='userfiles/$b_pic_1' alt='' style='border:0px;'/></a>";				
						//$breakfor = 1;
					}
					else continue;
			...
			<div class="left">
				...
				for($i=0;$i<$count;$i++) {
					...
					<?}
						...
						<div class="cat">
						<div class="header">
							<h2><a href="?act=cat&amp;lan=<?=$lan?>&amp;id=<?=$c_id?>" class="cat_title"><?=$c_name?></a></h2>
							</div>
							<ul>
						<?

							$resh_i = mysql_query("SELECT * FROM `records` WHERE `r_category` = ".$c_id." AND `r_show_".$lan."` > 0 Order by `r_ord` desc LIMIT 7");
							...
							for($ii=0;$ii<$count_i;$ii++){
								...
								if($ii<3){
									 ?>
										<li><div class="image">
											 <a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>" rel="nofollow">
											 <?if($r_pic_r){?> <img src="userfiles/<?=$r_pic_r?>" alt="" /><?}
												else{
											 ?>
											...
											<h3><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>"><?=$r_title_r?></a>
											<nobr class='p_time'><?=$r_date_r?></nobr></h3>
											<p><?=$r_short?></p>
										</li>
										
									<?
								}
								elseif($ii==3) {?></ul><ul class="older c<?=$i?>"><?}

								if($ii>=3) {?><li><a href="?act=news&amp;lan=<?=$lan?>&amp;id=<?=$r_id_r?>"><?=$r_title_r?></a></li><?}
							}
							?></ul>
							<div class="more mc<?=$i?>">more</div>
						</div>
						<?
		  ...
		  <div id="slider-wrapper">
            ...
            <div id="slider" class="nivoSlider">
			  ...
			  for($i=0;$i<$count;$i++)	{
    	        ...
    	        $h_nkar = mysql_result($resh, $i, "h_nkar");
				?>
			 <img src="userfiles/<?=$h_nkar?>" style='border: 1px solid #333333;'  alt=""/>
				<?}?>
...
<div id="footer">
	...
	<div class="left" style='height:56px;'>
		<p><i>&copy;</i> <?=date("Y")?> Yerkir Media TV Company</p>
		<p>Republic of Armenia, Yerevan, N 94 Charents</p>
		<p>Phone. + 374 10 576512, Fax + 374 10 576540, <a href="?act=pages&amp;lan=<?=$lan?>&amp;id=5">Contact Us</a></p>
	</div>
	<div class="right" style='height:56px;'>
		<p>News department:</p>
		<p>Phone. + 374 10 576498, <a href="?act=pages&amp;lan=<?=$lan?>&amp;id=5">Contact Us</a></p>
	</div>
...
<div id="footer">
	<div class="left" style='height:56px;'>
		<p><i>&copy;</i> <?=date("Y")?> Yerkir Media телевидение</p>
		<p>Республика Армении, г. Ерерван, ул.Чаренца,94</p>
		<p>Тел.: + 374 10 576512, Факс: + 374 10 576540, <a href="?act=pages&amp;lan=<?=$lan?>&amp;id=5">Связаться с Нами</a></p>
	</div>
	<div class="right" style='height:56px;'>
		<p>Раздел новостей</p>
		<p>Тел.: + 374 10 576498, <a href="?act=pages&amp;lan=<?=$lan?>&amp;id=5">Связаться с Нами</a></p>
	</div>
...
.gm-style-iw {max-width: none !important; min-width: none !important; max-height: none !important; min-height: none !important; overflow-y: hidden !important; overflow-x: hidden !important; line-height: normal !important; padding: 5px !important; }
	...
	<div class="left" style='height:56px;'>
		<p><i>&copy;</i> <?=date("Y")?> Yerkir Media Հեռուստաընկերություն</p>
		<p>Հայաստանի Հանրապետություն, Երեւան, Չարենցի N94</p>
		<p>Հեռ. + 374 10 576512, Ֆաքս + 374 10 576540, <a href="?act=pages&amp;lan=<?=$lan?>&amp;id=5">Կապ</a></p>
	</div>
	<div class="right" style='height:56px;'>
		<p>Նորությունների բաժին:</p>
		<p>Հեռ. + 374 10 576498, <a href="?act=pages&amp;lan=<?=$lan?>&amp;id=5">Կապ</a></p>
	</div>

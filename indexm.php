...
if ( preg_match( '/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i',
    ...
    header( 'Location: http://yerkirmedia.am/mobile' ) ;
error_reporting( 0 ) ;
session_start() ;
include "baza.php" ;
...
-->		
		...
		<div class="header">
			...
			<h2><a class="ankexcAsacA" href="?act=cat&lan=<?=
...
?>
							...
							<div class="ankAsacDiv">
								...
								<h3 class="ankAsacH3"><a href="?act=news&amp;lan=<?=
...
$resh_banners = mysql_query( "SELECT * FROM `banners` WHERE `id`=126 OR `id`=121 ORDER BY id DESC" ) ;
...
?>
        ...
        <div class='gorcynkerner_1'>
			...
			<iframe id="frameNews" src="/frameNews/index.php?l=<?=

$lan

?>" name="frameName"  style="width:276px;height:280px;overflow:hidden;" frameBorder='0'></iframe>
...
?></p>
		...
		<div class="header noborder" style="background:#e4e4e4;border:1px solid #bfbfbf;height:18px;margin-top:20px;"><h2 <?

    if ( $lan == "hy" )
        echo 'onclick="document.location=' . "'" .
            'http://www.youtube.com/user/yerkirmediatv?feature=results_main' . "'" .
...
?> <img src="s/i/video_f.png" style="margin-left:10px;" alt=''/></h2></div>
    ...
    for ( $i = 0; $i < $count; $i++ )
    {
        ...
        echo '<li style="height:152px;">
							...
							<div><img src="userfiles/' . $v_pic .
            '" style="width:190px;height:152px;" alt="" /></div>
							...
							<div class="asVideoDiv"><a href="?act=news&amp;lan=' . $lan . '&amp;id=' .
            $v_id . '#video">' . $v_title . '</a></div>
